...
class ExamplePlugin : public example_manager::Plugin {

public:
  void initialize(const ros::NodeHandle& parent_nh, const std::string& name, const std::string& name_space,
                  std::shared_ptr<example_manager::CommonHandlers_t> common_handlers);
...
PLUGINLIB_EXPORT_CLASS(example_plugins::example_plugin::ExamplePlugin, example_manager::Plugin)
